...
import static no.nav.pensjonbrevdata.config.BrevdataFeature.ENABLE_MISSING_BREVDATA;
    ...
    public BrevdataMapper() {
        ...
        brevMap.put("INFO_ENDR_UT_INNT", () ->
                new Doksysbrev("INFO_ENDR_UT_INNT",
                        false,
                        "Varsel - endring av ufÃ¸retrygd pÃ¥ grunn av inntekt",
                        BrevkategoriCode.VEDTAK,
                        DokumenttypeCode.U,
                        Arrays.asList(SprakCode.NB),
                        true,
        ...
        brevMap.put("OPPHOR_ENDRING_UT_BT", () ->
                new GammeltBrev("PE_UT_07_200",
                        ...
                        null,
                        "brevgr010"));
        if (toggle(ENABLE_MISSING_BREVDATA).isEnabled()) {
            brevMap.put("P1100", () ->
