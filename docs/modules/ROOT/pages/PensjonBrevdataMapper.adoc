...
Exstreambrev må inneholde følgende elementer i tillegg til elementene beskrevet over i <<index.adoc#brev-tabell,brev-tabellen>>:
...
Brev er kategorisert som enten Doksysbrev eller Exstrembrev.
