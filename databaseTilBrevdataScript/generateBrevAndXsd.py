...
def createGammeltBrev(brevkode, brevkodeInBrevsystem, redigerbart, dekode, brevkategori, dokumenttype, utland, visIPselv, regeltype, kravtype, dokumentkategori, synligForVeileder, brevkontekst, brevgruppe):
...
def createDoksysBrev(brevkode, brevkodeInBrevsystem, redigerbart, dekode, brevkategori, dokumenttype, utland, visIPselv, regeltype, kravtype, dokumentkategori, synligForVeileder, brevkontekst, dokumentmalId, felleselementId):
        ...
        for row in readCSV:
            if(row[18]=="1"):
                if(row[14]=="0" or row[14]==""):
                    ...
                    f = open(filename, "a")
                    f.write(str(createGammeltBrev(row[0],row[1], row[2], row[6], row[8], row[3], row[9], row[13], row[7], row[12], row[4], row[11], row[10], row[5])))
                    f.write("\n")
                    f.close()
                elif(row[14]=="1"):
                    counterDoksysBatchbrev+=1
                    f = open(filename, "a")
                    f.write(str(createDoksysBrev(row[0],row[1], row[2], row[6], row[8], row[3], row[9], row[13], row[7], row[12], row[4], row[11], row[10], row[15], "00001")))
                    f.write("\n")
                    f.close()
        ...
        for row in readCSV:
            if(row[9]=="1"):
                if(row[23]=="0" or row[23]==""):
                    counterGammel+=1
                    f = open(filename, "a")
                    f.write(str(createGammeltBrev(row[0],row[0], row[5], row[6], row[15], row[2], row[16], row[20], row[14], row[19], row[3], row[18], row[17], row[4])))
                    f.write("\n")
                    f.close()
                elif(row[23]=="1"):
                    counterDoksys+=1
                    f = open(filename, "a")
                    f.write(str(createDoksysBrev(row[0],row[0], row[5], row[6], row[15], row[2], row[16], row[20], row[14], row[19], row[3], row[18], row[17], row[22], "00001")))
                    f.write("\n")
                    f.close()
